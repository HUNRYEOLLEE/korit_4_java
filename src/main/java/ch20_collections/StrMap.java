...
public class StrMap {
    public static void main(String[] args) {
        ...
        System.out.println(strMap1);
        // Map의 특징 중 하나로 하나의 key 에는 하나의 value만 가능
        // 그래서 key 값이 동일하다면 value의 값은 최신의 것으로 덮어쓰기 됨

        // List의 경우에 특정 인덱스를 조회하고 싶다면
        // 리스트명.get(인덱스넘버); 의 형태로 확인할 수 있었음
        // Map의 경우에는 순서는 없는 대신 key가 잇기 때문에
        System.out.println(strMap1.get("kor2025002"));
        // 위와 같은 방법으로 출력이 가능. -> value값만 출력됨
