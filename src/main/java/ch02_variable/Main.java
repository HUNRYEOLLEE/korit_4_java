...
/*
    주석(comment) : Java 프로그램의 경우 폴더 및 파일의 전체 코드를 컴파일링하는데,
        거기서 오류가 하나라도 발생하면 전체 프로그램이 실행되지 않음.
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 이훈렬입니다.");
//        System.out.println(안녕하세요, 제 이름은 이훈렬입니다.); -> 오류 발생
        ...
        // 하드 코딩 : 명령문에 데이터(변수에 대입되지 않은 데이터를 리터럴(literal))를 바로 집어넣는 것
        ...
        System.out.println(name1 + name2 + name3);  // 153192
        System.out.println("" + name1 + name2 + name3);  // 이훈렬
        /*
...
//        int pi2 = 3.14;
        ...
        /*
            Java에서의 변수 표기 방식 :
                1. 카멜 표기법(Camel case)를 사용
                    ...
                    두 번째 단어의 첫 번재 문자만 대문자
                    ex) 한 단어 : result
                    ex) 두 단어 : myTestResult
                2. 특수 문자 지양
                cf) 파이썬 학습하신 분들은 파이썬 변수 표기 방식은 snake case라고 해서
        ...
        // 제가 위에 선언한 변수들에 여러분ㄷ들에게 적절한 데이터로 초기화하여
        // 저는 코라이 it 아카데미 4월 국비 과정을 수강하고 있는 누구누구입니다. ??살입니다. -> 줄바꿈
        // 제 전공은 어쩌고학과이며, mbti는 어쩌고입니다. 열심히 할게요!!!
        ...
        System.out.println("제 전공은 " + major4 + "과이며, mbti는 " + mbti4 + "입니다. 열심히 할게요!!");
